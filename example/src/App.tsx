...
import { Alert, BackHandler, LogBox, PermissionsAndroid, Platform, SafeAreaView, Text, TouchableOpacity, View } from 'react-native';
...
const App = () => {
	...
	const _renderTestButtons = () => {
		return (
			...
			>
				<TouchableOpacity onPress={() => setHidePositions(!hidePositions)} style={{ flexDirection: 'row', alignItems: 'center' }}>
					<View
						style={{
							width: 20,
							height: 20,
